...
| `HANDOFF-계보-SEO-읽는층.md` | lineage(상·정전·국가별 정전·감독 계보)의 **SEO 읽는층**(2026-07-05: /lineage/[slug] 업그레이드 ~202 + /film/x/honors 신설 895 — Tier-2 367편 포함) — 출처 표면화(코드맵+QID)·불변식(film_count 게이트 금지 등)·운영절차. |
