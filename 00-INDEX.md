...
| `HANDOFF-모바일앱-프리워치.md` | **모바일 앱 ("Pre-Watch Companion") 기획 정본 (2026-07-16, 구축 대기)** — 보기 전에 여는 앱: 프리워치 6축(TakeScore·What to Watch·Where to watch·Locations·Invitation·찜하기) + 접착제 4(검색·계정·Seen·푸시). SEO 무해 판정(조건 3)·비용(자체개발 시 연 고정비 ~$125+월 $0~44)·Expo+기존 Supabase 직결 아키텍처·구축 순서 P0~P4·불변식 8조. 모바일 앱 작업은 여기서 시작. |
