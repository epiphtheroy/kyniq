...
> **수행자: 다른 AI.** 전 수정 지점을 프로덕션 DB 실측(2026-07-15) + 코드 검증 파일:라인으로 지정.
> ⚠️ 라인 번호는 ba08347 기준 — 착수 시 각 항목의 `현재:` 코드 인용과 **내용 대조 후** 수정(라인 점프 금지).
...
| D6 감독 게이트 술어·noindex 규모 | **배포 전 SQL 실측 후 확정** — 예상 ≤506, 정확 수치를 오너 보고 |
