...
Accountability is not only a claim in prose; it is written into the machine-readable record of the site. Our pages carry structured data naming the person behind them and linking out to external records that verify the credentials stated — a publisher's author page, a doctoral thesis held in the Korean national research archive. Search engines and other machines that read the site therefore get the same answer a reader does to the question *who is responsible for this?*
...
> If a page states a fact wrongly, tell us and it will be fixed as verified — corrections reach the desk directly, under the same [corrections](/methodology#corrections) loop as everything else on the site.
`;
export default body;
