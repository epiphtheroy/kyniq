...
1. **Question page modules** (§6.11): **"More about {film}"** (other questions on the same
   film) and **"Related readings"** — questions about **similar films**, across the catalogue
   (no categories, §3.2; semantic similarity is the v2 upgrade). Cap ~5–6 each, quiet.
...
- A question page surfaces same-film questions and **film-similarity** cross-film "Related
  readings" (published-only; no category field).
