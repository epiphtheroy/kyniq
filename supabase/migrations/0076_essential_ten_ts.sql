-- 0076 — Essential Ten: TakeScore on the second row too (owner 2026-07-11:
-- drop external Metascore/RT from the section; our TakeScore everywhere).
-- Full re-statement of home_v2_bundle_v3 (from 0071) with ONE change: the
-- top10 rows (#4-10) now carry ts/tsv/tsr like every other film object.
