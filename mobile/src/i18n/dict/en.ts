...
export const en = {
  ...
  "film.scoreValue": "Earned value",
  "film.scoreValueSub": "what a serious viewer keeps — higher is better",
  "film.scoreCost": "Entry cost",
  "film.scoreCostSub": "what it takes to unlock — a price, never a merit",
  "film.scoreRisk": "Risk",
  "film.scoreRiskSub": "how it can go wrong — lower is safer",
  "film.scoreFormula": "TakeScore = Earned value − Risk. Entry cost is a difficulty, not a demerit.",
  "film.scoreFormulaN": "TakeScore = Earned value − Risk, and lands at {ts}. Entry cost is a difficulty, not a demerit.",
  "film.scoreHonors": "The value is earned: this film sits in {n} canons and awards — listed under Lineage below.",
  "film.scoreFull": "How the score is built",
  ...
  "my.notifyUnavailable": "Not available on Android yet — this turns on when push delivery ships",
  "my.account": "Account",
  "my.signIn": "Sign in",
  "my.signOut": "Sign out",
  ...
  "list.addFailed": "Couldn't add this list to your watchlist.",
  "list.drive": "Drive it",
  ...
  "explore.locations": "Filming locations",
  "explore.locationsSub": "Every place these films were shot — including the ones near you.",
  ...
  "connect.leave.title": "Still importing",
  "connect.leave.body": "It keeps going if you leave — nothing is cancelled. Come back to Connect and the summary will be waiting.",
  "connect.leave.stay": "Keep watching",
  "connect.leave.go": "Leave it running",
