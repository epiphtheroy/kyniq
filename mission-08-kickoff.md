...
2. **Global chrome** — finalize header + footer per `ref-chrome.html` (logged-in avatar menu:
   ...
   Privacy, company line (Kyniq · address · contact.kyniq@gmail.com), TMDB attribution,
   © 2026 Kyniq, locale switcher.
3. **Institutional pages** (§6.9), server-rendered (E-E-A-T): `/about` (mission + the Kino+IQ+
   Unique etymology + the AI-assisted/human-reviewed disclosure, per `ref-about.html`);
