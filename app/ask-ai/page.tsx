    ...
    <div className="mt">
      ...
      <div className="ak-wrap">
        <div className="ak-head">
          ...
          <p className="ak-stamp"><span className="ak-gl">▦</span> Grounded in the corpus · retrieved, then composed — every claim linked to its source · <Link href="/chat" className="ak-foot__link">Try Chat →</Link></p>
