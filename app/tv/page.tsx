...
// METATAKE TV — the channel. The TV plays large at the top (embedded, not full-
// screen); beneath it a live "dossier" pulls in whatever the TV is currently on —
// the film, the lens in full, deep links — so the broadcast doubles as a way into
// the site (page-within-page). (Was /random "Surprise me"; that URL now redirects.)
    ...
    <div className="mt tvpg">
      ...
      <div className="tvpg-wrap">
        <header className="tvpg-head">
          ...
          <a className="tvpg-full" href="/tv/watch">Watch lists ↗</a>
