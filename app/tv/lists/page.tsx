...
// /tv/lists — the browse UI for every METATAKE TV watch list. Server-seeds the
// first page + the axis summary; the client component handles filter/search/
// pagination via /api/tv/directory.
...
export const metadata: Metadata = {
  ...
  description: "Browse every METATAKE TV watch list — directors, canons, awards, movements, genres, countries, decades, theorists, tropes, concepts and archetypes, each compiled into broadcasts with no LLM.",
