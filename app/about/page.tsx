...
export default function AboutPage() {
  return (
    <main className="shell">
      <h1 className="disp" style={{ fontSize: 30, margin: "28px 0 0" }}>About Kyniq</h1>
      ...
      <p className="body reading" style={{ fontSize: 18, margin: 0 }}>
        ...
        Kyniq gathers those questions, one film at a time, and lets readers build an answer together — a single,
      ...
      <div className="tick" />
      <p className="body reading" style={{ fontSize: 18, margin: 0 }}>
        <span className="disp" style={{ fontSize: 18 }}>Kyniq</span> blends{" "}
      ...
      <div className="tick" />
      <p className="body reading" style={{ fontSize: 18, margin: 0 }}>
        Some initial readings are drafted with AI and reviewed by the Kyniq editorial team. These are always
