...
/**
 * Settings — the private account page, and (since 2026-08-04) the web's home for
 * the two preferences the app has always had and the site never did:
 *
 *   ① Where you watch — country + the services you pay for, plus saved pairings.
 *   ② Film titles     — the language films are NAMED in.
 *
 * Both live ABOVE the profile because they are what a viewer actually comes here
 * to change, and both work signed out: they are local-first prefs (mirrored to
 * user_prefs when there is a session), so this page no longer bounces an
...
export default function SettingsPage() {
  ...
  // No early return on `loading`: the two preference blocks below don't depend on
  // who you are, so they must not wait on an auth round trip. Only the profile /
  // account half does.
  return (
    <main className="shell">
      ...
      {/* ① Where you watch — country + services, one surface (the app's StepEdition) */}
      ...
      <p className="ui muted" style={{ fontSize: 12.5, margin: "0 0 12px", maxWidth: 560 }}>
        ...
        what you can actually watch, using these. Signed in, they follow you to the app and back.
      </p>
      <WatchSetup />
