...
export const alt = "Metatake — meta takes & strong misreadings";
...
async function loadMinimal(slug: string) {
  ...
  return {
    ...
    laconic: mt.laconic as string | null,
...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
  try {
    ...
    const { title, laconic, filmCount } = data;
    ...
    const statsLine = filmCount ? `${filmCount} film${filmCount === 1 ? "" : "s"}` : null;
