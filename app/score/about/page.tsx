...
export default function ScoreAbout() {
  return (
    <div className="mt">
      <SiteNav />
      <div className="mt-wrap lh ab">
        <div className="lh-crumb"><Link href="/score">The Metatake Score</Link></div>
        ...
        <Row k="MTS · Net" tone="ab-v">
          ...
          films fall; lower it and you reward ambition. You set λ on the <Link href="/score">Score page</Link>.
        </Row>
        ...
        <p style={{ marginTop: 22 }}><Link className="ab-back" href="/score">← Explore films by Metatake Score</Link></p>
      </div>
    </div>
  );
}
