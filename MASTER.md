...
> 🧭 **전략("왜/어디로")은 [HANDOFF-사업전략-생존과성장.md](HANDOFF-사업전략-생존과성장.md)를 보라** —
> 해자·청중·1~2년 궤적·생존 플레이북의 북극성 정본(살아있는 문서). 이 MASTER는 "어떻게(로직·파이프라인·런북)"를 다룬다.
...
### 8.7 연결 탐색기 (디렉토리식 드릴다운) — migration 0018
