  ...
  return (
    <div className="mflband">
      <div className="wrap mflrow">
        ...
        <p className="mflp">
          <b>My Films</b> — flip the whole site to the films you&rsquo;ve seen: a red border on
          every poster you know, or the galaxy, atlas and lists re-centred on your own history.
          {hasLens ? (
